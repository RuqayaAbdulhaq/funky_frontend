                    ...
                    <div class="box-page-404">
                        <div class="text-center mb-150 mt-100">
                            <div class="box-404 row">
                                <div class="col-lg-6">
                                    <div class="image-404"><img src="{{ asset('imgs/page/404/404.svg') }}"
                                            alt="Page not found"></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="info-404 text-start mt-60">
                                        <h2 class="color-linear mb-20">Don't be spooked !</h2>
                                        <p class="text-xl color-gray-500">The page you’re looking for has slipped in to an
                                            unknown realm. Click the button below to go back to the homepage.</p>
                                        <div class="mt-25"><a class="btn btn-linear hover-up" href="/">Homepage</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
