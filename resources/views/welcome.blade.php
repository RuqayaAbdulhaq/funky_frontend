    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Funky Frontend has an incredibly rich ecosystem.
                    <br>We suggest starting with the following.</p>
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        ...
                        <span>
                            Read the
                            <a href="https://Funky Frontend.com/docs" target="_blank"
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://cloud.Funky Frontend.com" target="_blank"
